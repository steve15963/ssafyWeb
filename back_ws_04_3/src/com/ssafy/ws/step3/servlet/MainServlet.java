...
import com.ssafy.ws.step3.service.IUserService;
...
public class MainServlet extends HttpServlet {
    ...
    public MainServlet() {
        ...
        iUserService = UserServiceImpl.getInstance();
    }
	...
	private void doLogin(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			User user = iUserService.login(id, pass);
...
//			session.setAttribute("user", new User(id,pass,"김싸피",null));
